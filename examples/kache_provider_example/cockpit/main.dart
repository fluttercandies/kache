...
import 'package:kache_provider_example/main.dart' as prod;

/// Cockpit development entrypoint.
///
/// Wraps the production root with [FlutterCockpitApp]. The remote control
/// surface is resolved from the dart-defines injected by `launch-app`;
...
Widget buildCockpitDevelopmentApp() {
  return FlutterCockpitApp(
    ...
    child: const prod.KacheProviderExampleApp(),
  );
}
