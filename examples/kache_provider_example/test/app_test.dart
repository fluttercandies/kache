...
import 'package:kache_provider_example/main.dart';

void main() {
  testWidgets('loads repository data through KacheProvider', (tester) async {
    final fetch = Completer<RepositoryProfile>();
    final store = await HiveCeKacheStore.open(
      boxName: 'provider_example_app_test',
      bytes: Uint8List(0),
    );
